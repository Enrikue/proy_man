					...
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
			      		...
			      		<div class="form-group mb-3">
			      			...
			      			<input type="text" class="form-control" placeholder="Username" required id="usr_txt">
			      		</div>
		            <div class="form-group mb-3">
		            	<label class="label" for="password">Contraseña</label>
		              <input type="password" class="form-control" placeholder="Password" required id="psswd_txt">
		            </div>
